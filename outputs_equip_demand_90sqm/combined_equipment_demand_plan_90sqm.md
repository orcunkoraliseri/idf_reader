# Combined Equipment Demand Investigation Plan (90.0 sqm Variant)
## IDF: `US+SF+CZ6A+gasfurnace+unheatedbsmt+IECC_2024.idf`
## Zone Target Floor Area: **90.0 m²**
...
*(Note: This plan applies the demand schedules extracted from the IECC 2024 single family model over a hypothetical **90.0 m²** floor area scenario requested by the user, adjusting W/m² peak parameters accordingly).*
...
| **Peak Design Level (W/m²)** | **13.1174 W/m²** |
| **Annual Energy** | **7047.6 kWh/yr** |
| **Annual Energy Density** | 78.31 kWh/m²/yr |
...
| **Peak Design Level (W/m²)** | **9.5337 W/m²** |
| **Annual Energy** | **3225.7 kWh/yr** |
| **Annual Energy Density** | 35.84 kWh/m²/yr |
...
All files written to `outputs_equip_demand_90sqm/`:
...
> **Modelling assumption**: Electric and gas equipment are modelled separately using energy-weighted composite schedules derived from the IECC 2024 US Single-Family IDF. Values represent the combined internal gain from all appliances in each fuel category for a **90.0 sqm** target floor area.

| Parameter | Electric | Gas |
|---|---|---|
| `EquipmentPerFloorArea` | **13.1174 W/m²** | **9.5337 W/m²** |
...
python equipment_demand_composer.py \
    ...
    --floor-area 90.0 \
    --out-dir outputs_equip_demand_90sqm
```
