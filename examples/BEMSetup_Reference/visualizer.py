...
def visualize_idf(idf_path, idd_path):
    ...
    try:
        ...
        counts = {'wall': 0, 'roof': 0, 'floor': 0, 'ceiling': 0, 'window': 0, 'other': 0}
        ...
        for surf in surfaces:
            ...
            if bc not in ['outdoors', 'ground', 'groundslab', 'groundbasementpreprocessedaverage']:
                ...
                if 'ground' not in bc and 'outdoors' not in bc:
                    ...
                    if 'wall' in surf_type and bc in ['zone', 'surface', 'adiabatic']:
                        ...
                        poly = Poly3DCollection([abs_coords], alpha=1.0, facecolors='red', edgecolors='black')
            ...
            poly = Poly3DCollection([abs_coords], alpha=1.0, facecolors=color, edgecolors='black')
            ax.add_collection3d(poly)
            ...
            for sub in subsurfs:
                if sub.Building_Surface_Name == surf.Name:
                    ...
                    sub_abs_coords = [(x+dx, y+dy, z+dz) for x, y, z in sub_coords]
                    
                    sub_poly = Poly3DCollection([sub_abs_coords], alpha=0.8, facecolors='lightblue', edgecolors='black')
